...
`r fa("file-pdf", fill = "#562457")` [PDF presentation](https://github.com/wenlanzhang/Presentation/blob/3762c58c6a4c63039f594989c56774b61eac51c7/index.pdf)
...
```{r include=FALSE}
library(renderthis)
renderthis::to_pdf("GroupPre_FieldTrip.html")
```
