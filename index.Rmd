...
Thanks to Mr.Mark Ojal for the connection
...
**Slums**
  ...
  * History reason: Colonisation (and high temperature?)
...
**Urban Villages**  
  ...
  * History reason: Rapid urbanization (and land ownership)
...
2 level of study? for NGO and UN-Habitact
...
read_excel(here("tables", "abbreviations.xlsx"))%>%
  # arrange(Individual) %>%  # i.e. alphabetical order by Term
